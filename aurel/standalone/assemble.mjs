...
const content = `<title>AUREL ARC</title>
<style>
${FONTS}${css}
</style>
<div id="aurel-root"></div>
<script>
${js}
</script>
`;

await writeFile(resolve(dist, "aurel.html"), content, "utf8");
...
console.log("aurel.html:", (content.length / 1024 / 1024).toFixed(2), "MB");
